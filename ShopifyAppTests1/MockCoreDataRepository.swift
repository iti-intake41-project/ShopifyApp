...
class MockCoreDataRepository: LocalDataRepository {
    
    var productList = [Product]()
    var favouriteList = [Product]()
    var delegate: NSManagedObjectContext
    
    init(delegate: inout NSManagedObjectContext) {
